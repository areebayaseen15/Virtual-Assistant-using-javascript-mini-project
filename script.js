...
function takeCommand(message) {
    ...
    if (message.includes("hello") || message.includes("hey") || message.includes("Hello , areeba") || message.includes("hey , areeba")) {
        wishMe();
        ...
        speak("I am a virtual assistant, created by Mam Areeba Yaseen.");
    } 
